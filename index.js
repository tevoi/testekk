...
case 'mia':
               ...
               case 'mia2':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://imgbb.com/`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '(hihihih)'})
					break
               case 'porno':
					memein = await kagApi.memeindo()
		   ...
		   await limitAdd(sender)
			...
			case 'closegp':
               ...
               if (anu.error) return reply(anu.error)
            	...
            	case 'mia':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://mulherpelada.blog/wp-content/uploads/2019/06/Mia-Khalifa-pelada-7.jpg`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '(hihihih)'})
					break
               case 'mia2':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://www.fotosmulherpelada.com/wp-content/uploads/2017/09/Mia-Khalifa-pelada-04-1.jpg`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '(hihihih)'})
					break
		    	case 'grupoinfo':
                    client.updatePresence(from, Presence.composing)
